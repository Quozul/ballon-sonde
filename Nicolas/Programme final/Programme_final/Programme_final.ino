...
float mark[6]= {bme680.sensor_result_value.temperature, bme680.sensor_result_value.pressure / 100, bme680.sensor_result_value.humidity,25,29,136.24};

    
    if (1 == 1)
    {

      Tft.drawString ("28/03 14:40 25%",0,5,2,WHITE);
      ...
      Tft.drawString("Vitesse vent:",0,175,2,WHITE);             // draw char: 'E', (10, 10), size: 2, color: BLUE
