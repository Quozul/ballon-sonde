...
/*
 ...
 2 January 2013 - corrected spelling of 'Triangle' 
 in "void TFT::drawTraingle( int poX1, int poY1, int poX2, int poY2, int poX3, int poY3, INT16U color)"
 25 February 2013 - Added code for test direction
 John Martin
*/
...
void TFT::setOrientation(INT8U HV)//horizontal or vertical
{
  sendCMD(0x03);
    if(HV==1)//vertical
    {
...
void TFT::setDisplayDirect( char Direction) 
{
